...
//650317/1743273/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPS5420QDRQ1" (originalName "TPS5420QDRQ1")
	...
	(compDef "TPS5420QDRQ1" (originalName "TPS5420QDRQ1") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "8" (pinName "PH") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "VIN") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "GND") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "ENA") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPS5420QDRQ1"))
		...
		(attr "Mouser Part Number" "595-TPS5420QDRQ1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TPS5420QDRQ1?qs=wkx8pu8tL7J7TtwDHJoKDw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPS5420QDRQ1")
		(attr "Description" "Voltage Regulators - Switching Regulators 2A Wide-Input-Range Step-Down Converter")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tps5420-q1.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TPS5420QDRQ1.stp")
