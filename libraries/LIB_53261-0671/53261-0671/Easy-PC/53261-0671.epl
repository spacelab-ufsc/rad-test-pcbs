...
(library Library_1
	...
	(patternDef "532610671" (originalName "532610671")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.000, 0.800) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -6.125 -2.1) (pt 6.125 -2.1) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.125 -2.1) (pt 6.125 2.1) (width 0.2))
		)
	...
	(compDef "53261-0671" (originalName "53261-0671") (compHeader (numPins 8) (numParts 1) (refDesPrefix J)
		...
		(attr "Datasheet Link" "https://www.molex.com/pdm_docs/sd/532610671_sd.pdf")
		(attr "Height" "3.6 mm")
	)
